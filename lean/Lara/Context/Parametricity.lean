...
theorem relTerms_iff_forall₂ {R : Assurance → Assurance → Prop}
    {ws₁ ws₂ : List SupportTerm} :
...
theorem relTerms_length {R : Assurance → Assurance → Prop}
    {ws₁ ws₂ : List SupportTerm} (h : RelTerms R ws₁ ws₂) :
    ws₁.length = ws₂.length :=
...
theorem relInj_injective {R : Assurance → Assurance → Prop} (hR : RelInj R)
...
theorem relInj_graphOf {f : Assurance → Assurance} (hf : Function.Injective f) :
    RelInj (graphOf f) := by
  intro α₁ α₂ β₁ β₂ h₁ h₂
  subst h₁; subst h₂
...
theorem relPreserving_graphOf {f : Assurance → Assurance}
...
theorem relFixesContext_graphOf {f : Assurance → Assurance} {C : Context}
...
mutual
  ...
  theorem relTerm_inj {R : Assurance → Assurance → Prop} (hR : RelInj R) :
      ∀ {w₁ w₂ v₁ v₂ : SupportTerm},
  ...
  theorem relTerms_inj {R : Assurance → Assurance → Prop} (hR : RelInj R) :
  ...
  theorem relDis_inj {R : Assurance → Assurance → Prop} (hR : RelInj R) :
...
theorem relAtt_source_inj {R : Assurance → Assurance → Prop} (hR : RelInj R)
...
theorem relDis_length {R : Assurance → Assurance → Prop}
    {D₁ D₂ : List (QuestionId × SupportTerm)} (h : RelDis R D₁ D₂) :
...
theorem relDis_keys {R : Assurance → Assurance → Prop}
    {D₁ D₂ : List (QuestionId × SupportTerm)} (h : RelDis R D₁ D₂) :
...
theorem relTerms_getElem?_right {R : Assurance → Assurance → Prop}
    {ws₁ ws₂ : List SupportTerm} (h : RelTerms R ws₁ ws₂) {i : Nat}
...
theorem relTerms_getElem?_left {R : Assurance → Assurance → Prop}
    {ws₁ ws₂ : List SupportTerm} (h : RelTerms R ws₁ ws₂) {i : Nat}
    {w₁ : SupportTerm} (hi : ws₁[i]? = some w₁) :
    ∃ w₂, ws₂[i]? = some w₂ ∧ RelTerm R w₁ w₂ :=
...
theorem relDis_getElem?_right {R : Assurance → Assurance → Prop} :
...
theorem relDis_lookup {R : Assurance → Assurance → Prop} :
...
theorem relTerm_subterm {R : Assurance → Assurance → Prop} :
...
raises. -/
theorem hasSupport_rel {canon : String → String} {Pi : RuleId → Option Rule}
    {Gamma : LeafId → Option Atom}
    {CertOk₁ CertOk₂ : BackendId → Digest → CertRef → List Atom → Atom → Prop}
    {R : Assurance → Assurance → Prop}
    (hpres : RelPreserving R CertOk₁ CertOk₂) :
...
theorem hasAttack_rel {canon : String → String} {Pi : RuleId → Option Rule}
    {Gamma : LeafId → Option Atom}
    {CertOk₁ CertOk₂ : BackendId → Digest → CertRef → List Atom → Atom → Prop}
...
theorem conflictAttackableB_rel {R : Assurance → Assurance → Prop}
    (Pi : RuleId → Option Rule) {t₁ t₂ : SupportTerm} (h : RelTerm R t₁ t₂) :
    conflictAttackableB Pi t₂ = conflictAttackableB Pi t₁ := by
  cases h <;> rfl

theorem attackFor_rel {R : Assurance → Assurance → Prop}
    {s₁ s₂ t₁ t₂ : SupportTerm} (hs : RelTerm R s₁ s₂) (ht : RelTerm R t₁ t₂) :
...
theorem crossAttsFrom_inner_rel {R : Assurance → Assurance → Prop}
...
theorem crossAttsFrom_rel {R : Assurance → Assurance → Prop}
    (canon : String → String) (dp : DefeatPolicy) (Pi : RuleId → Option Rule) :
...
theorem conclusionCache_rel {canon : String → String}
    {reg₁ reg₂ : BackendRegistry canon} {Pi : RuleId → Option Rule}
...
theorem crossAtts_rel {canon : String → String}
    {reg₁ reg₂ : BackendRegistry canon} {R : Assurance → Assurance → Prop}
...
theorem dedupList_rel {R : Assurance → Assurance → Prop} (hR : RelInj R) :
...
theorem linkFault_rel {R : Assurance → Assurance → Prop} {C : Context}
    {F₁ F₂ : Fragment} (hF : RelFrag R F₁ F₂) :
...
theorem linkOk_rel {R : Assurance → Assurance → Prop} {C : Context}
    {F₁ F₂ : Fragment} (hF : RelFrag R F₁ F₂) : linkOk C F₂ = linkOk C F₁ := by
  simp only [linkOk, linkFault_rel hF]

theorem linkGamma_rel {R : Assurance → Assurance → Prop} {C : Context}
    {F₁ F₂ : Fragment} (hF : RelFrag R F₁ F₂) :
    linkGamma C F₂ = linkGamma C F₁ := by
  simp only [linkGamma, hF.gammaFrag]

theorem linkGround_rel {R : Assurance → Assurance → Prop} {C : Context}
    {F₁ F₂ : Fragment} (hF : RelFrag R F₁ F₂) :
...
theorem link_rel_commutes {canon : String → String}
    {reg₁ reg₂ : BackendRegistry canon} {R : Assurance → Assurance → Prop}
    {C : Context} {F₁ F₂ : Fragment}
    (hR : RelInj R)
    (hpres : RelPreserving R (certOkOf reg₁) (certOkOf reg₂))
...
mutual
  ...
  theorem termWellSorted_rel {R : Assurance → Assurance → Prop}
  ...
  theorem termsWellSorted_rel {R : Assurance → Assurance → Prop}
      {sg : Sigma.Sigma} {P : Policy.Policy} :
  ...
  theorem dischargesWellSorted_rel {R : Assurance → Assurance → Prop}
      {sg : Sigma.Sigma} {P : Policy.Policy} :
      ∀ {D₁ D₂ : List (QuestionId × SupportTerm)}, RelDis R D₁ D₂ →
...
theorem argsWellSorted_rel {R : Assurance → Assurance → Prop}
    {sg : Sigma.Sigma} {P : Policy.Policy} {args₁ args₂ : List SupportTerm}
...
theorem signatureStage_rel {R : Assurance → Assurance → Prop} {ground : List Atom}
    {unit₁ unit₂ : Lara.Unit}
...
theorem relAtt_source {R : Assurance → Assurance → Prop} {k₁ k₂ : Attack.Attack}
    (hk : RelAtt R k₁ k₂) : RelTerm R k₁.source k₂.source := by
  cases hk <;> assumption

theorem relAtt_target {R : Assurance → Assurance → Prop} {k₁ k₂ : Attack.Attack}
...
theorem attackOcc_rel_exists {R : Assurance → Assurance → Prop}
...
theorem attackOcc_rel {R : Assurance → Assurance → Prop} (hR : RelInj R)
...
theorem contains_rel {R : Assurance → Assurance → Prop} (hR : RelInj R)
    {v₁ v₂ t₁ t₂ : SupportTerm}
...
theorem covered_rel {R : Assurance → Assurance → Prop}
...
theorem conflictAttackable_rel {R : Assurance → Assurance → Prop}
    {Pi : RuleId → Option Rule} {t₁ t₂ : SupportTerm} (h : RelTerm R t₁ t₂)
...
theorem attackComplete_rel {canon : String → String}
    {reg₁ reg₂ : BackendRegistry canon} {Pi : RuleId → Option Rule}
    {Gamma : LeafId → Option Atom} {dp : DefeatPolicy}
    {R : Assurance → Assurance → Prop}
...
theorem nodup_rel {R : Assurance → Assurance → Prop} (hR : RelInj R) :
...
theorem checkUnit_rel {canon : String → String}
    {reg₁ reg₂ : BackendRegistry canon} {Gamma : LeafId → Option Atom}
    {R : Assurance → Assurance → Prop} {ground : List Atom}
    {unit₁ unit₂ : Lara.Unit}
...
theorem relTerms_getElem?_none {R : Assurance → Assurance → Prop}
    {ws₁ ws₂ : List SupportTerm} (h : RelTerms R ws₁ ws₂) {i : Nat}
...
shares the key. -/
theorem relDis_lookup_none {R : Assurance → Assurance → Prop} :
    ∀ {D₁ D₂ : List (QuestionId × SupportTerm)}, RelDis R D₁ D₂ →
...
theorem relTerm_subterm_none {R : Assurance → Assurance → Prop} :
...
mutual
  ...
  theorem containsB_rel {R : Assurance → Assurance → Prop} (hR : RelInj R) :
      ∀ {w₁ w₂ t₁ t₂ : SupportTerm},
  ...
  theorem containsBList_rel {R : Assurance → Assurance → Prop} (hR : RelInj R) :
  ...
  theorem containsBDis_rel {R : Assurance → Assurance → Prop} (hR : RelInj R) :
...
-/
theorem attackClosureB_rel {R : Assurance → Assurance → Prop} (hR : RelInj R)
...
theorem coveredB_rel {R : Assurance → Assurance → Prop} (hR : RelInj R)
    {atts₁ atts₂ : List Attack.Attack} {s₁ s₂ t₁ t₂ : SupportTerm}
    (hatts : Forall₂ (RelAtt R) atts₁ atts₂)
    (hs : RelTerm R s₁ s₂) (ht : RelTerm R t₁ t₂) :
    coveredB atts₂ s₂ t₂ = coveredB atts₁ s₁ t₁ := by
...
theorem nodes_conclusion_rel {canon : String → String}
    {reg₁ reg₂ : BackendRegistry canon} {Gamma : LeafId → Option Atom}
    {R : Assurance → Assurance → Prop}
...
framework. -/
theorem compileUnit_rel {canon : String → String}
    {reg₁ reg₂ : BackendRegistry canon} {Gamma : LeafId → Option Atom}
    {R : Assurance → Assurance → Prop}
    {acc₁ : Lara.Unit.CheckedUnit canon Gamma (certOkOf reg₁)}
    {acc₂ : Lara.Unit.CheckedUnit canon Gamma (certOkOf reg₂)}
...
theorem exists_accepted_rel {canon : String → String}
    {reg₁ reg₂ : BackendRegistry canon} {R : Assurance → Assurance → Prop}
    {C : Context} {F₁ F₂ : Fragment}
    (hR : RelInj R)
    (hpres : RelPreserving R (certOkOf reg₁) (certOkOf reg₂))
...
theorem compileUnit_link_rel {canon : String → String}
    {reg₁ reg₂ : BackendRegistry canon} {R : Assurance → Assurance → Prop}
    {C : Context} {F₁ F₂ : Fragment}
    (hR : RelInj R)
    (hpres : RelPreserving R (certOkOf reg₁) (certOkOf reg₂))
...
theorem congruence_correspondence {canon : String → String}
...
mutual
  ...
  theorem relTerm_self {R : Assurance → Assurance → Prop} :
  ...
  theorem relTerms_self {R : Assurance → Assurance → Prop} :
  ...
  theorem relDis_self {R : Assurance → Assurance → Prop} :
...
theorem relAtt_self {R : Assurance → Assurance → Prop} :
...
theorem relFixesContext_occRel {C : Context} {F : Fragment}
