; An alignment naming a claim the member does not declare.
(map-check-input@1
  (policy empirical-v1)
  ...
  (alignments (alignment (ref paper_a c1 whole) (ref paper_b c9 whole) same (author r) (audit-status unreviewed) (rationale ""))))
