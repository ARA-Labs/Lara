...
forward-looking obligation (**issue #226**). F1 did not need it —
...
- **Issue #219** (closed) — the five `DecidableEq` instances R-L3 needs
...
- **Issue #226** (closed) — the cache-agreement bridge (§4): proved as
