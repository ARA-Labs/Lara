...
- **S8** is the named-`nd@1` binder/premise/formula demonstrator
  ...
  `(atom KEY)` wrapper (grammar Appendix I, closing
  [#144](https://github.com/ARA-Labs/lara/issues/144)). Thus the
