...
- **Last revised**: 2026-09-07 (2026-09-07_001#3)
...
- **Proof**: [`Lara.Context.obsGen_congr` and its four instantiations, `lean/Lara/Context/Observation.lean`; `Lara.Context.compileUnit_link_relabel`, `lean/Lara/Context/Equivalence.lean:586`; `Lara.Observation.observe_congr`, `lean/Lara/Observation.lean:406`; `Lara.Invariants.observeSem_grounded` (the companion unconditional `Nodup` discharge); `ara/evidence/proofs/m4_generic_observation.md`; `docs/theory-m4-generic-observation.md` §2-§3; PR #271; trace N327, N328]
