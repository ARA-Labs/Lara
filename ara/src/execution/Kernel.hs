-- Grounding: transcribed — verbatim from src/Lara/Kernel.hs (repo), the LP proof-term
-- checker / non-conforming adapter seed. Grounds C03 (as the seed that motivated the
-- backend interface). Do not edit here; edit the repo file.
